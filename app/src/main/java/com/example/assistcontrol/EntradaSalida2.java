...
public class EntradaSalida2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DocumentReference document2 = db.collection("UNAN, León").document(userID).collection("Salida2").document(date);
    ...
    public void verificacion_entrada_salida() {
        ...
        final DocumentReference document4 = db.collection("UNAN, León").document(userID).collection("Entrada2").document(date_actual);
                    ...
                    if (document.exists()) {
                        ...
                        document5.update("Estado2", "0").addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Log.d(TAG, "Se actualizó el estado porque si marcaste entrada2 hoy, solo verificar. :)");
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        if (MAC.exists()) {
                                            ...
                                            Log.d(TAG, s_hora);
                                            if (estado2.equals("1")) {
                                                DocumentReference verificar_entrada = db.collection("UNAN, León").document(userID).collection("Entrada2")
                                                        .document(s_fecha);
                                                verificar_entrada.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            if (v_entrada.exists()) {
                                                                StyleableToast.makeText(EntradaSalida2.this, "¡Ya marcó su Entrada!", R.style.toasttyle_entrada).show();
                                                            } else {
                                                                ...
                                                                document.update("Estado2", "0").addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                    ...
                                                                    public void onSuccess(Void aVoid) {
                                                                        ...
                                                                        Log.d(TAG, "Se actualizó el estado2. :)");
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (MAC.exists()) {
                                    ...
                                    Log.d(TAG, s_hora);
                                    if (estado2.equals("0")) {
                                        DocumentReference verificar_entrada = db.collection("UNAN, León").document(userID).collection("Salida2").document(s_fecha);
                                        verificar_entrada.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                            @Override
                                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    if (v_salida.exists()) {
                                                        StyleableToast.makeText(EntradaSalida2.this, "¡Ya marcó su Salida!", R.style.toasttyle_salida).show();
                                                    } else {
                                                        DocumentReference document = db.collection("UNAN, León").document(userID);
                                                        document.update("Estado2", "1").addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                            ...
                                                                            public void onSuccess(Void aVoid) {
                                                                                ...
                                                                                documenthsal.update("HoraSalida2", s_hora).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                    ...
                                                                                    public void onSuccess(Void aVoid) {
                                                                                        ...
                                                                                        DocumentReference documenthsal2 = db.collection("UNAN, León").document(userID).collection("Salida").document(s_fecha);
                                                            ...
                                                            @Override
                                                            public void onFailure(@NonNull Exception e) {
                                                                Log.d(TAG, "No se actualizó el estado2. :(");
                                                            }
                                                        });
                                                    }
                                                }
